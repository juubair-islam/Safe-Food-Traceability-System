    ...
    <div class="nav-links">
      ...
      <li class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="http://localhost:3000/Safe-Food-Traceability-System/admin/add_user.php">Add User</a>
                        <a href="http://localhost:3000/Safe-Food-Traceability-System/admin/view_users.php">View Users</a>
                    </div>
        ...
        <li><a href="http://localhost:3000/Safe-Food-Traceability-System/admin/add_farmer.php"class="active">Farmers</a></li>
